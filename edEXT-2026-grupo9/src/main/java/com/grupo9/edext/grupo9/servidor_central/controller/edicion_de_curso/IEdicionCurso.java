...
public interface IEdicionCurso {
    ...
    public abstract void altaEdicionCurso(String nEdi, Curso cur, LocalDate fInicio, LocalDate fFin, Integer c, Set<InscEdicion> insc, Docente d) throws ErrorRepetidos;
