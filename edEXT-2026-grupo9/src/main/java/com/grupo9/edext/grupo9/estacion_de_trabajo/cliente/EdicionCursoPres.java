...
public class EdicionCursoPres {
    ...
    public void guardarNuevaEdicion(String nombreEdi, Curso curso, LocalDate fechaInicio, LocalDate fechaFin, Integer cupo, Set<Docente> docentes){
        ...
        DataCurso dataCurso = new DataCurso(toData(curso.getInstituto()),  curso.getNombreCurso(),  curso.getDescCurso(), curso.getDuracion(), curso.getCantHoras(), curso.getCantCred(), curso.getFechaReg(), curso.getUrl(), null, null);
    ...
    public HashSet<DataEdicionCurso> traerEdiciones(DataCurso dataCurso) {
        return this.servidorCentral.traerEdiciones(dataCurso);
    }
